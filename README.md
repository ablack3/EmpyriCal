...
📖 **Documentation: <https://ablack3.github.io/EmpyriCal/>** — the methods, the
mathematics behind them, why empirical calibration works, and worked code
...
```
src/empiricalcalibration/   the Python package
tests/                      pytest suite
examples/                   runnable scripts reproducing the R vignettes
docs/                       Quarto source for the documentation site
extras/r-package/           the original OHDSI R package, kept for reference
extras/r-parity/            scripts that generate and check the R gold standard
